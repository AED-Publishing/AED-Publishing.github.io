...
export default function TestimonialsFade({ pageHeaderBgImg, pageHeaderMinVh, reviews }: Props) {
  const styles = {
    pageHeader: {
  ...
  const renderHeader = (pageHeaderBgImg, pageHeaderMinVh) => {
    if (!pageHeaderBgImg || !pageHeaderMinVh) {
      return;
    }
    return (
          ...
          <div className="row justify-content-center">
            <div className="col-sm-9 text-center mx-auto pt-6">
              ...
              <p className="lead mb-sm-5 px-md-8">
                ...
                being a bright color. For standing out. But the time is now to be okay to be the greatest you.
              </p>
  ...
  const renderReviews = (reviews) => {
    ...
    return (
      <div className="container">
        <h3 className="font-weight-bolder mt-4 mb-2">Playtester's Opinions</h3>
        <p className="mb-5 w-60">
          All playtesters had no pre-existing relationship with AED Publishing before trying playing and sharing their
          experience.
        </p>
        <div className="row">
          {reviews.map((review) => {
              ...
              <div className="col-12 col-md-6 col-lg-4">
                <div className="card border shadow-xs mb-4">
                  <div className="card-body text-start p-3 w-100">
                    {review.rating ? <Reviews rating={review.rating} /> : null}
  ...
  return (
    <>
      <section>
        {renderHeader(pageHeaderBgImg, pageHeaderMinVh)}
